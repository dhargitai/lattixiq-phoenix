/**
 * AI Provider Service for Action Roadmap Preparator
 *
 * Self-contained AI model configuration and selection.
 * Provides consistent model access for analysis and generation tasks.
 */
